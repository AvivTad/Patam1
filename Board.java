...
public class Board {
    ...
    static
    {
        BonousScore.put("7,7","star"); // star(the center of the board)
        BonousScore.put("0,3","DoubleLettScor"); //light blue
        ...
        BonousScore.put("1,5","TripelLettScor"); //blur
        ...
        BonousScore.put("1,1","DoubleWorScore"); //yellow
        ...
        BonousScore.put("0,0","TripelWorScor"); // red
    ...
    public boolean isFirst(Word a) {
        ...
        if(Middle==null)
        {
            if(a.getVertical())
            {
                if(a.getCol()==7)
                {
                    for(int i=a.getRow();i<a.getRow()+a.getLength();i++)
                    {
                        if(i==7)
                            return true;
                    }
            ...
            else
            {
                if(a.getRow()==7)
                {
                    for(int i=a.getCol();i<a.getCol()+a.getLength();i++)
                    {
                        if(i==7)
                            return true;
                    }
        ...
        if (word.getVertical()== true)
        {
            ...
            for (int i = 0;i< word.getLength();i++)
            {
                ...
                if (BonousScore.containsKey(str3));
                {
                    ...
                    if(Bonous==null)
                    {
                        sum += TheBoard.matBoard[word.getRow()+i][word.getCol()].getScore();
                        continue;
                    }
                    switch (Bonous) {
                        case "star": {
                        ...
                        case "DoubleLettScor": {
                            sum  += 2 * TheBoard.matBoard[word.getRow()+i][word.getCol()].getScore();
                        }break;
                        case "TripelLettScor": {
                            sum += 3 *  TheBoard.matBoard[word.getRow()+i][word.getCol()].getScore();
                        }break;
                        case "DoubleWorScore": {
                            flag *= 2;
                            sum +=  TheBoard.matBoard[word.getRow()+i][word.getCol()].getScore();
        ...
        else // not vertical
        {
            ...
            for (int j = 0;j< word.getLength();j++)
            {
                ...
                if (BonousScore.containsKey(str3));
                {
                    String Bonous = new String();
                    Bonous = BonousScore.get(str3);
                   // Bonous = BonousScore.get("%d,%d".formatted(i,j));
                    if(Bonous==null) {
                        sum +=  TheBoard.matBoard[word.getRow()][word.getCol()+j].getScore();
                        continue;
                    }
                    switch (Bonous) {
                        case "star": {
                        ...
                        case "DoubleLettScor": {
                            sum  += 2 * TheBoard.matBoard[word.getRow()][word.getCol()+j].getScore();
                        }break;
                        case "TripelLettScor": {
                            sum += 3 * TheBoard.matBoard[word.getRow()][word.getCol()+j].getScore();
                        }break;
                        case "DoubleWorScore": {
                            flag *= 2;
                            sum += TheBoard.matBoard[word.getRow()][word.getCol()+j].getScore();
    ...
    public int tryPlaceWord(Word word)
    {
        ...
        if (dictionaryLegal(word)== true) {
            if (boardLegal(word) == true) {
                if (word.getVertical()== true)
                {
                    for (int i =0; i<word.getLength();i++)// initialize on bord
                    {
